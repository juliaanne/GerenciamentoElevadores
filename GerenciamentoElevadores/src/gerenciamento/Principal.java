...
public class Principal{
	...
	private static void validaAndares(int qtdeAndares) {
		if(qtdeAndares >= andares){
			printWriter.println("Na entrada, n√£o deve existir requisicoes sobrando");
			System.out.println("Na entrada, n√£o deve existir requisicoes sobrando");
			System.exit(0);
		}	
	}
	...
	private static void validaRequisicoes(String requisicoes, int andarAtual) {
		...
		for(int i = 1; i < quantidadeRequisicoes; i++){
			...
			printWriter.println("RequisiÁ„o (id= "+ requisicao.getId() + ") com destino para o andar: [" + requisicao.getAndarDestino() + "] adicionada no andar [" + andarAtual + "]");
		}
	...
	public static void main (String[] args) throws IOException {
		...
		// Reservando espa√ßo para vetor de threads
